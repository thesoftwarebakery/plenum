...
* typed path parameter coercion using OAS schema ([fa79789](https://github.com/thesoftwarebakery/plenum/commit/fa797899239d87d4d7d94006cc2a5bee2cbae40d))


### Bug Fixes

* collapse nested if-let to satisfy clippy::collapsible_if ([a15a78d](https://github.com/thesoftwarebakery/plenum/commit/a15a78d0443bc6b7c24c57f6d2aa51d20afbb552))

## [0.14.1](https://github.com/thesoftwarebakery/plenum/compare/v0.14.0...v0.14.1) (2026-04-30)
...
* The following workspace dependencies were updated
  * dependencies
    * oapi-overlay bumped from ^0 to 0.2.0
